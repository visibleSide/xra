...
<div class="row mb-30-none">
            ...
            <div class="content pt-0">
                <div class="list-wrapper">
                    <ul class="list">
                        ...
                        <li>{{ __("Zip Code") }}<span>{{ $transaction->remittance_data->zip_code ?? 'N/A'  }}</span></li>
                        <li>{{ __("Address") }}<span>{{ $transaction->remittance_data->address ?? 'N/A'  }}</span></li>
            ...
            <div class="content pt-0">
                <div class="list-wrapper">
                    <ul class="list">
                        ...
                        <li>{{ __("Transaction Type") }} <span>{{ $transaction->remittance_data->type ?? ''  }}</span> </li>
    ...
    <form action="{{ setRoute('admin.send.remittance.status.update',$transaction->trx_id) }}" method="post">
        @csrf
        <div class="col-lg-12 mb-30">
            <div class="transaction-area">
