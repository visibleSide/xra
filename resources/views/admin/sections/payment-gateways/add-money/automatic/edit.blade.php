...
@section('breadcrumb')
    ...
    ], 'active' => __("Automatic Ramitance Gateway Edit")])
@endsection

@section('content')
    <form action="{{ setRoute('admin.payment.gateway.update',['remittance-gateway','automatic',$gateway->alias]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
