    ...
    <div class="table-area">
        <div class="table-wrapper">
            <div class="table-header">
                <h5 class="title">{{ __("Automatic Remittance Gateway") }}</h5>
                @env('local')
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('admin.components.link.edit-default',[
                                        'href'          => setRoute('admin.payment.gateway.edit',['remittance-gateway','automatic',$item->alias]),
...
@push('script')
    <script>
        $(document).ready(function(){
            openModalWhenError("automatic-remittance-gateway","#p-gateway-automatic-add");
